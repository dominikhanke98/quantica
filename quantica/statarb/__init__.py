...
* **Synthetic data** (:mod:`~quantica.statarb.data`) — cointegrated pairs, spurious random
  walks, and known-parameter OU paths for the known-truth validation.

Later steps (not in this foundation): the Kalman-filter dynamic hedge ratio, and the
mean-reversion strategy run through the portfolio backtest and its DSR/PBO validity layer.
"""
